            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <section className="space-y-8">
                        <div className="p-8 border-4 border-black dark:border-white/10 bg-white dark:bg-white/[0.03] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(59,130,246,0.3)]">
                        ...
                        <div className="p-8 border-4 border-red-500 dark:border-red-500/50 bg-red-50 dark:bg-red-500/10 shadow-[8px_8px_0px_0px_rgba(239,68,68,1)] dark:shadow-[8px_8px_0px_0px_rgba(239,68,68,0.3)]">
                            <div className="flex items-center gap-2 text-red-600 dark:text-red-400 mb-4">
                                <AlertTriangle size={20} />
                                <h2 className="text-xl font-black uppercase italic">Danger Zone</h2>
                            </div>
                            <p className="text-xs font-bold mb-6 text-red-800 dark:text-red-300 uppercase">Deleting this project will remove all associated telemetry data instantly.</p>
                            <button
